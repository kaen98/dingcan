/*TMODJS:{"version":12,"md5":"e527757903044a59ee9d9c06e9b7074c"}*/
...
$out+=' </div> </div> </div> <a class="next mybtn" href="javascript:submitOrder();" > <span style="display: block; height: 39px; font-size: 1.2em;margin: 10px;background: #ff6703;color: #ffffff;border-radius: 6px;">提交订单</span> </a> <div style="padding-top:80px;"> <a href="javascript:void(0);" style="text-align: center;color: #949494;font-size: 12px;display: block;"></a> </div>';
