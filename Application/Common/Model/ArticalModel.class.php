...
class ArticalModel extends RelationModel
{
    ...
    public function get($condition = array(), $relation = false, $isAnalysis = false)
    {
        ...
        if ($condition["id"] && $isAnalysis) {
            $this->where(array("id" => $condition["id"]))->setInc("visiter");
        }
