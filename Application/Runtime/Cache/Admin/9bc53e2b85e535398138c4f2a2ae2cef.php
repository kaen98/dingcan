...
<head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/dist/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/dist/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/dist/css/AdminLTE.min.css">

    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/dist/css/skins/_all-skins.min.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/plugins/daterangepicker/daterangepicker-bs3.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
    <script src="/git/dingcan/Public/Admin/dist/js/html5shiv.min.js"></script>
    <script src="/git/dingcan/Public/Admin/dist/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" href="/git/dingcan/Public/Admin/toastr/toastr.min.css">

    <!-- jQuery 2.1.4 -->
    <script src="/git/dingcan/Public/Admin/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <script>
        var URL = '/git/dingcan/';
        var UEURL = '/git/dingcan/Public/Admin/UEditor/';
        var PUBLICURL = '/git/dingcan/Public';
        var UPLOADSURL = '/git/dingcan/Public/Uploads/';
    </script>
    <!--ueditor-->
    <script type="text/javascript" charset="utf-8" src="/git/dingcan/Public/Admin/UEditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/git/dingcan/Public/Admin/UEditor/ueditor.all.min.js"></script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="/git/dingcan/Public/Admin/UEditor/lang/zh-cn/zh-cn.js"></script>

    <script type="text/javascript" charset="utf-8" src='/git/dingcan/Public/Admin/nprogress/nprogress.js'></script>
    <link rel='stylesheet' href='/git/dingcan/Public/Admin/nprogress/nprogress.css'/>
</head>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <!--<li class="dropdown tasks-menu">-->
                        ...
                        <!--<ul class="dropdown-menu" style="height: 796px;max-width: 377px">-->
                            <!--<link rel="stylesheet" href="/git/dingcan/Public/Preview/app.css">
...
-->
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/git/dingcan/Public/Admin/dist/img/avatar-wemall.png" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo (session('adminName')); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/git/dingcan/Public/Admin/dist/img/avatar-wemall.png" class="img-circle"
                                     alt="User Image">
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="<?php echo U('Admin/Order/order',array('status'=>-3));?>"><i class="fa "></i>已退货</a></li>
        <li><a href="<?php echo U('Admin/Order/order',array('status'=>2));?>"><i class="fa "></i>已完成</a></li>
        <li><a href="<?php echo U('Admin/Order/order',array('status'=>-1));?>"><i class="fa "></i>已取消</a></li>
    </ul>
</li>
            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Admin/Artical/addArtical');?>" class="btn btn-danger ">
                                新增文章
                            </a>
                        </div>
                        <!-- /.btn-group -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($articalList)): $i = 0; $__LIST__ = $articalList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$artical): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <div class="btn-group" style="margin: 0px">
                                            ...
                                            <div class="dropdown-menu">
                                                <img style="height: 200px"
                                                     src="/git/dingcan/Public/Uploads/<?php echo ($artical["savepath"]); echo ($artical["savename"]); ?>">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="table-action"><a
                                            href="<?php echo U('Admin/Artical/modArtical',array('id'=>$artical['id']));?>">修改</a><a
                                            href="<?php echo U('Admin/Artical/delArtical',array('id'=>$artical['id']));?>">删除</a></td>
                            ...
                            <div class="mailbox-controls">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger"
                                            onclick="batchUrl('<?php echo U('Admin/Artical/delArtical');?>')">全部删除
                                    </button>
                                </div>
...
<div id="loading" style="top: 150px;">
    <div class="lbk"></div>
    <div class="lcont"><img src="/git/dingcan/Public/Admin/dist/img/loading.gif" alt="loading...">正在加载...</div>
</div>

<!-- Bootstrap 3.3.5 -->
<script src="/git/dingcan/Public/Admin/bootstrap/js/bootstrap.min.js"></script>
<!-- ChartJS 1.0.1 -->
<script src="/git/dingcan/Public/Admin/plugins/chartjs/Chart.min.js"></script>
<!-- daterangepicker -->
<script src="/git/dingcan/Public/Admin/dist/js/moment.min.js"></script>
<script src="/git/dingcan/Public/Admin/plugins/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="/git/dingcan/Public/Admin/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="/git/dingcan/Public/Admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="/git/dingcan/Public/Admin/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="/git/dingcan/Public/Admin/plugins/fastclick/fastclick.min.js"></script>
<!-- AdminLTE App -->
<script src="/git/dingcan/Public/Admin/dist/js/app.min.js?v=1"></script>
<!--layer-->
<script src="/git/dingcan/Public/Admin/layer/layer.js"></script>
<!--toastr-->
<script src="/git/dingcan/Public/Admin/toastr/toastr.min.js"></script>
<!--bootbox-->
<script src="/git/dingcan/Public/Admin/bootbox/bootbox.js"></script>
<!--pjax-->
<script src="/git/dingcan/Public/Admin/pjax/jquery.pjax.js"></script>
<!--jquery.form-->
<script src="/git/dingcan/Public/Admin/form/jquery.form.js"></script>
<!--template-->
<script src="/git/dingcan/Public/Admin/dist/js/template.js"></script>
<script src="/git/dingcan/Public/Admin/dist/js/wemall.js?v=2"></script>
