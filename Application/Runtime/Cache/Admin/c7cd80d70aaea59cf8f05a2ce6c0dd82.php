            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Admin/Weixin/addWxReply');?>" class="btn btn-danger ">
                                新增自定义回复
                            </a>
                        </div>
                        <!-- /.btn-group -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($wxReply)): $i = 0; $__LIST__ = $wxReply;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wxReply): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <img style="height: 200px"
                                                         src="/git/dingcan/Public/Uploads/<?php echo ($wxReply["savepath"]); echo ($wxReply["savename"]); ?>">
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                                    ...
                                    <td class="table-action"><a
                                            href="<?php echo U('Admin/Weixin/modWxReply',array('id'=>$wxReply['id']));?>">修改</a><a
                                            href="<?php echo U('Admin/Weixin/delWxReply',array('id'=>$wxReply['id']));?>">删除</a>
                                    </td>
                            ...
                            <div class="mailbox-controls">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger"
                                            onclick="batchUrl('<?php echo U('Admin/Weixin/delWxReply');?>')">全部删除
                                    </button>
                                </div>
                            </div>
                        </div>
